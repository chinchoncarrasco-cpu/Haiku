...
- Para transferencias bancarias, Glosa es la referencia COMPLETA de la transferencia, no sólo el nombre del emisor. Cuando el operador aporte un texto con el patrón "número inicial + Transf de + nombre", conserva todo ese texto unido en pago.glosa. El número inicial corresponde al identificador/RUT mostrado en la referencia y forma parte de la glosa; no lo descartes ni lo muevas a documento.
- Conserva exactamente la glosa de transferencia, incluidos ceros iniciales y las palabras visibles. Ejemplo: "0170274954 Transf de PAULETTE MARIA KATH" debe devolverse íntegramente como glosa="0170274954 Transf de PAULETTE MARIA KATH".
