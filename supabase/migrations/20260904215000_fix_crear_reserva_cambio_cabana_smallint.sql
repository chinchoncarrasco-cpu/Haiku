...
begin
  ...
  v_resultado := public.haiku_crear_reserva(
    ...
    p_adultos => greatest(coalesce(p_adultos, 0::smallint), 0::smallint)::smallint,
    p_ninos => greatest(coalesce(p_ninos, 0::smallint), 0::smallint)::smallint,
    p_mascotas => greatest(coalesce(p_mascotas, 0::smallint), 0::smallint)::smallint,
    ...
    p_tipo_estadia => 'alojamiento'::text,
  ...
  loop
    ...
    insert into public.reserva_estadias(
      ...
      greatest(coalesce(p_adultos, 0::smallint), 0::smallint)::smallint,
      greatest(coalesce(p_ninos, 0::smallint), 0::smallint)::smallint,
      greatest(coalesce(p_mascotas, 0::smallint), 0::smallint)::smallint,
